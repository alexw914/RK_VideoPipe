...
void PostProcessor::set_class_num(int obj_class_num, char *label_name){
    OBJ_CLASS_NUM = obj_class_num;
    PROP_BOX_SIZE = 5 + OBJ_CLASS_NUM;
    printf("Load LabelName %s\n", label_name);
    readLines(label_name, labels, OBJ_CLASS_NUM);
};

int PostProcessor::process(int8_t* input, int* anchor, 
...
int PostProcessor::run(int8_t* input0, int8_t* input1, int8_t* input2, 
...
)
{
    ...
    int validCount0 = 0;
    validCount0 = process(input0, (int*)anchor0, grid_h0, grid_w0, stride0, filterBoxes, objProbs,
    ...
    int validCount1 = 0;
    validCount1 = process(input1, (int*)anchor1, grid_h1, grid_w1, stride1, filterBoxes, objProbs,
    ...
    int validCount2 = 0;
    validCount2 = process(input2, (int*)anchor2, grid_h2, grid_w2, stride2, filterBoxes, objProbs,
...
PostProcessor::PostProcessor(const int obj_class_num, char *label_name,
                          const float &conf_threshold, const float &nms_threshold){
    this->OBJ_CLASS_NUM = obj_class_num;
    this->PROP_BOX_SIZE = 5 + OBJ_CLASS_NUM;
